...
func verifyAfterSyscoinTypeBlock1(t *testing.T, d *RocksDB, afterDisconnect bool) {
	...
	if dBAsset.AssetObj.Symbol != base64.StdEncoding.EncodeToString("CAT") {
		t.Fatal(fmt.Sprint("Block1: Property mismatch dBAsset.AssetObj.Symbol: ", dBAsset.AssetObj.Symbol , ". Expected: " + base64.StdEncoding.EncodeToString("CAT")))
	}
...
func verifyAfterSyscoinTypeBlock2(t *testing.T, d *RocksDB) {
	...
	if dBAsset.AssetObj.Symbol != base64.StdEncoding.EncodeToString("CAT") {
		t.Fatal(fmt.Sprint("Block2: Property mismatch dBAsset.AssetObj.Symbol: ", dBAsset.AssetObj.Symbol , ". Expected: " + base64.StdEncoding.EncodeToString("CAT")))
	}
