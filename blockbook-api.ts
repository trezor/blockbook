...
export interface TokenTransfer {
    /** Type of token transfer (e.g., ERC20, ERC721, etc.). */
    type: string;
...
export interface ContractInfo {
    /** Type of the token contract (e.g. ERC20, ERC721). */
    type: string;
...
export interface Token {
    /** Type of token (e.g., ERC20, ERC721, etc.). */
...
export interface Address {
    ...
    totalSent?: string;
    /** Balance in mempool (unconfirmed). */
    ...
    /** Deprecated: same as contractInfo for ERC20. */
