...
type Token struct {
	Type             bchain.TokenTypeName `json:"type" ts_type:"'XPUBAddress' | 'ERC20' | 'ERC721' | 'ERC1155'" ts_doc:"Type of token (e.g., ERC20, ERC721, etc.)."`
...
type TokenTransfer struct {
	Type             bchain.TokenTypeName `json:"type" ts_doc:"Type of token transfer (e.g., ERC20, ERC721, etc.)."`
...
type Address struct {
	...
	UnconfirmedBalanceSat *Amount              `json:"unconfirmedBalance" ts_doc:"Balance in mempool (unconfirmed)."`
	...
	Erc20Contract         *bchain.ContractInfo `json:"erc20Contract,omitempty" ts_doc:"Deprecated: same as contractInfo for ERC20."`
