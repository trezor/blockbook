...
type RpcReceipt struct {
	...
	EffectiveGasPrice string    `json:"effectiveGasPrice,omitempty" ts_doc:"Actual gas price paid per gas unit; on L2 networks this differs from the transaction gasPrice bid."`
