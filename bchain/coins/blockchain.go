...
import (
	...
	"github.com/trezor/blockbook/bchain/coins/satoxcoin"
...
func init() {
	...
	BlockChainFactories["Satoxcoin"] = satoxcoin.NewSatoxcoinRPC
	BlockChainFactories["Satoxcoin Testnet"] = satoxcoin.NewSatoxcoinRPC
}
