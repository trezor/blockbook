...
func (x *ProtoCompleteTransaction) Reset() {
	*x = ProtoCompleteTransaction{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ethtx_proto_msgTypes[0]
...
func (*ProtoCompleteTransaction) Descriptor() ([]byte, []int) {
	return file_ethtx_proto_rawDescGZIP(), []int{0}
}
...
func (x *ProtoCompleteTransaction_TxType) Reset() {
	*x = ProtoCompleteTransaction_TxType{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ethtx_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ProtoCompleteTransaction_TxType) Descriptor() ([]byte, []int) {
	return file_ethtx_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *ProtoCompleteTransaction_ReceiptType) Reset() {
	*x = ProtoCompleteTransaction_ReceiptType{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ethtx_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ProtoCompleteTransaction_ReceiptType) Descriptor() ([]byte, []int) {
	return file_ethtx_proto_rawDescGZIP(), []int{0, 1}
}
...
func (x *ProtoCompleteTransaction_ReceiptType_LogType) Reset() {
	*x = ProtoCompleteTransaction_ReceiptType_LogType{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ethtx_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ProtoCompleteTransaction_ReceiptType_LogType) Descriptor() ([]byte, []int) {
	return file_ethtx_proto_rawDescGZIP(), []int{0, 1, 0}
}
...
var File_ethtx_proto protoreflect.FileDescriptor

var file_ethtx_proto_rawDesc = []byte{
	0x0a, 0x0b, 0x65, 0x74, 0x68, 0x74, 0x78, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x07, 0x69,
	0x6f, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x22, 0xb4, 0x05, 0x0a, 0x18, 0x50, 0x72, 0x6f, 0x74, 0x6f,
	...
	0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x4e,
	...
	,
	...
	,
	...
	0x04, 0x44, 0x61, 0x74, 0x61, 0x12, 0x16, 0x0a, 0x06, 0x54, 0x6f, 0x70, 0x69, 0x63, 0x73, 0x18,
	0x03, 0x20, 0x03, 0x28, 0x0c, 0x52, 0x06, 0x54, 0x6f, 0x70, 0x69, 0x63, 0x73, 0x42, 0x04, 0x5a,
	0x02, 0x2e, 0x2f, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_ethtx_proto_rawDescOnce sync.Once
	file_ethtx_proto_rawDescData = file_ethtx_proto_rawDesc
)

func file_ethtx_proto_rawDescGZIP() []byte {
	file_ethtx_proto_rawDescOnce.Do(func() {
		file_ethtx_proto_rawDescData = protoimpl.X.CompressGZIP(file_ethtx_proto_rawDescData)
	})
	return file_ethtx_proto_rawDescData
}

var file_ethtx_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_ethtx_proto_goTypes = []interface{}{
	(*ProtoCompleteTransaction)(nil),                     // 0: iochain.ProtoCompleteTransaction
	(*ProtoCompleteTransaction_TxType)(nil),              // 1: iochain.ProtoCompleteTransaction.TxType
	(*ProtoCompleteTransaction_ReceiptType)(nil),         // 2: iochain.ProtoCompleteTransaction.ReceiptType
	(*ProtoCompleteTransaction_ReceiptType_LogType)(nil), // 3: iochain.ProtoCompleteTransaction.ReceiptType.LogType
}
var file_ethtx_proto_depIdxs = []int32{
	1, // 0: iochain.ProtoCompleteTransaction.Tx:type_name -> iochain.ProtoCompleteTransaction.TxType
	2, // 1: iochain.ProtoCompleteTransaction.Receipt:type_name -> iochain.ProtoCompleteTransaction.ReceiptType
	3, // 2: iochain.ProtoCompleteTransaction.ReceiptType.Log:type_name -> iochain.ProtoCompleteTransaction.ReceiptType.LogType
...
func init() { file_ethtx_proto_init() }
func file_ethtx_proto_init() {
	if File_ethtx_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_ethtx_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_ethtx_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_ethtx_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_ethtx_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_ethtx_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_ethtx_proto_goTypes,
		DependencyIndexes: file_ethtx_proto_depIdxs,
		MessageInfos:      file_ethtx_proto_msgTypes,
	}.Build()
	File_ethtx_proto = out.File
	file_ethtx_proto_rawDesc = nil
	file_ethtx_proto_goTypes = nil
	file_ethtx_proto_depIdxs = nil
}
