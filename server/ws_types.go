...
type WsSendTransactionReq struct {
	...
	Data           string `json:"data,omitempty" ts_doc:"Hex-encoded transaction data to broadcast (json format)."`
	AlternativeRPC bool   `json:"alternativeRpc" ts_doc:"Use alternative RPC method to broadcast transaction."`
}
