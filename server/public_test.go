	...
	tests := []struct {
		...
		},
		{
			...
			body: []string{
				...
				`3172.83951061 FAKE <a class="r3c-text-danger" href="/spending/7c3be24063f268aaa1ed81b64776798f56088757641a34fb156c4f51ed2e9d25/0" title="Spent">➡</a></span>`,
				...
				`td><span class="ellipsis tx-addr"><a href="/address/mtR97eM2HPWVM6c8FGLGcukgaHHQv7THoL">mtR97eM2HPWVM6c8FGLGcukgaHHQv7THoL</a></span><span class="tx-amt">`,
				`9172.83951061 FAKE <span class="r3c-text-success" title="Unspent"> <b>×</b></span></span>`,
		...
		},
		{
			...
			body: []string{
				...
				`<td><span class="ellipsis tx-addr"><a href="/address/2NEVv9LJmAnY99W1pFoc5UJjVdypBqdnvu1">2NEVv9LJmAnY99W1pFoc5UJjVdypBqdnvu1</a></span><span class="tx-amt">0.00009876 FAKE <a class="r3c-text-danger" href="/spending/effd9ef509383d536b1c8af5bf434c8efbf521a4f2befd4022bbd68694b4ac75/2" title="Spent">➡</a></span></td>`,
				`</html>`,
			},
		},
		{
		...
		},
		{
			...
			body: []string{
				...
				`<div class="alert r3c-alert-danger">Invalid data</div>`,
				`</html>`,
			},
		},
		{
...
func socketioTestsBitcoinType(t *testing.T, ts *httptest.Server) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: `{"result":{"blocks":225494,"testnet":true,"network":"fakecoin","subversion":"/Fakecoin:0.0.1/","coin_name":"Fakecoin","about":"Blockbook - blockchain indexer derived from SathoshiLabs operated by RIDDLE\u0026CODE GmbH."}}`,
		},
		{
